        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 lg:gap-8 pb-20 justify-items-center">
          ...
          <CardContainer className="inter-var w-full">
            <CardBody className="bg-[#0a0a0a] relative group/card shadow-xl shadow-black/40 hover:shadow-2xl hover:shadow-black/80 border-white/[0.1] w-full max-w-[24rem] h-[34rem] rounded-2xl p-6 border flex flex-col">
              ...
              >
                Developed an event-driven emergency response platform bridging
                custom IoT panic buttons with a Gemini AI backend. Processes
                hardware payloads in milliseconds, utilizing Vertex AI for
                pattern analysis and Gemini for instant context generation.
                Features real-time Socket.io dashboards and zero-latency
                Firebase dispatch.
              </CardItem>
          ...
          <CardContainer className="inter-var w-full">
            <CardBody className="bg-[#0a0a0a] relative group/card shadow-xl shadow-black/40 hover:shadow-2xl hover:shadow-black/80 border-white/[0.1] w-full max-w-[24rem] h-[34rem] rounded-2xl p-6 border flex flex-col">
              ...
              <CardItem
                ...
                className="text-white/60 text-sm max-w-sm mt-3 shrink-0 leading-relaxed"
              >
                Architected an AI-driven satellite monitoring platform
                leveraging Sentinel-2 imagery and temporal ML models to track
                ecological restoration. The system dynamically computes NDVI
                improvements to classify vegetation health. A blockchain
                verification layer anchors all environmental gains, ensuring an
          ...
          <CardContainer className="inter-var w-full">
            <CardBody className="bg-[#0a0a0a] relative group/card shadow-xl shadow-black/40 hover:shadow-2xl hover:shadow-black/80 border-white/[0.1] w-full max-w-[24rem] h-[34rem] rounded-2xl p-6 border flex flex-col">
              ...
              <CardItem
                ...
                className="text-white/60 text-sm max-w-sm mt-3 shrink-0 leading-relaxed"
              >
                Engineered a Self-Adaptive Hybrid Search RAG architecture that
                dynamically assesses query complexity before retrieval. Blends
                dense semantic vector search with sparse BM25 keyword matching
                to maximize recall and precision. Incorporates an LLM routing
                layer to autonomously select retrieval strategies before
