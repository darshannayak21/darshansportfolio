    ...
    >
      ...
      <div id="bento-grid" className="w-full px-6 md:px-12 lg:px-20 max-w-[1400px] mx-auto pb-24">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6 auto-rows-[220px]">
          ...
          <Link to="/moreabout#more-about" className="col-span-1 md:col-span-1 md:row-span-1 group relative overflow-hidden rounded-[2rem] bg-[#1e4620] p-6 flex flex-col justify-between transition-transform duration-300 hover:scale-[1.02]">
          ...
          {/* Current Interests */}
          <Link to="/moreabout#interests" className="col-span-1 md:col-span-1 md:row-span-1 group relative overflow-hidden rounded-[2rem] bg-[#1d4ed8] p-6 flex flex-col justify-between transition-transform duration-300 hover:scale-[1.02]">
          ...
          <Link to="/moreabout#work" className="col-span-1 md:col-span-2 md:row-span-2 group relative overflow-hidden rounded-[2rem] bg-orange p-8 md:p-10 flex flex-col justify-end transition-transform duration-300 hover:scale-[1.02]">
          ...
          {/* My Journey */}
          <Link to="/moreabout#journey" className="col-span-1 md:col-span-2 md:row-span-1 group relative overflow-hidden rounded-[2rem] bg-white p-8 flex flex-col justify-between transition-transform duration-300 hover:scale-[1.02]">
            <div>
